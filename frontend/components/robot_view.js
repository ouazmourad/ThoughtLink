...
RobotView.prototype._drawObj = function(ctx, obj, scale, toC) {
    ...
    if (obj.type === "box") {
        ...
        if (cat==="wall") { ctx.fillStyle=color; ctx.fillRect(p.x,p.y,wp,hp); this._label(ctx,toC(obj.x,obj.y),"BACK WALL","#999",scale); }
